const JiraIcon = () => (
  <svg height="2500" viewBox="2.59 0 214.09101008 224" width="2361" xmlns="http://www.w3.org/2000/svg">
    ...
    <linearGradient id="b" x1="114.65" x2="160.81" href="#a" y1="85.77" y2="131.92"/>
