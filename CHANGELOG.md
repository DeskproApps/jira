...
### Fixed
  ...
  - DP-3463 - Fix errors when fields have no key
...
### Added
  ...
  - pre-loader screen
  - admins can now use autogenerated ssh keys  
  
### Fixed

  - renamed fields in the admin settings form
  - basic input sanitization for admin settings form
  - "Send comment to JIRA" is no longer shown on reply box even when the ticket is not linked to any issues.
...
[Unreleased]: https://github.com/DeskproApps/jira/compare/v0.2.1...HEAD
[0.2.1]: https://github.com/DeskproApps/jira/compare/v0.2.0...v0.2.1
